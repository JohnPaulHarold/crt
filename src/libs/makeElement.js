...
/** @type {ShorthandMakeElement}  */
export const section = (...args) => makeElement('section', args[0], ...args.slice(1));
/** @type {ShorthandMakeElement}  */
...
/** @type {ShorthandMakeElement}  */
export const button = (...args) => makeElement('button', args[0], ...args.slice(1));
/** @type {ShorthandMakeElement}  */
export const h1 = (...args) => makeElement('h1', args[0], ...args.slice(1));
/** @type {ShorthandMakeElement}  */
export const h2 = (...args) => makeElement('h2', args[0], ...args.slice(1));
/** @type {ShorthandMakeElement}  */
export const header = (...args) => makeElement('header', args[0], ...args.slice(1));
/** @type {ShorthandMakeElement}  */
